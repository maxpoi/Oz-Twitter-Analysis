...
# return 统计得到的数字
def count_keyword_in_different_cities(keyword, city, max_num, api, db):
...
def main():
    ...
    for city in city_geo:
        count += count_keyword_in_different_cities(search_keyword, city, twitter_max_num, api, db)
